...
struct ArMapFileLineCompare {
    typedef const ArMapFileLine& first_argument_type;
    typedef const ArMapFileLine& second_argument_type;
...
struct ArMapFileLineGroupCompare {
    typedef const ArMapFileLineGroup& first_argument_type;
    typedef const ArMapFileLineGroup& second_argument_type;
    typedef bool result_type;
// {

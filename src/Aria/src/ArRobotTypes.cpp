...
{
  // snprintf(mySubClass, "amigo");
  snprintf(mySubClass, sizeof(mySubClass), "%s", "amigo");
  myRobotRadius = 180;
  myRobotDiagonal = 120;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "amigo-sh");
  myRobotRadius = 180;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 300;
  myAbsoluteMaxVelocity = 1000;
...
AREXPORT ArRobotAmigoShTim5xxWibox::ArRobotAmigoShTim5xxWibox(const char* dir)
  : ArRobotAmigoSh(dir)
{
  // snprintf(mySubClass, "amigo-sh-tim3xx");
  snprintf(mySubClass, sizeof(mySubClass), "%s", "amigo-sh-tim3xx");
  if (getLaserData(1) != NULL)
  {
    // snprintf(getLaserData(1)->myLaserType, "tim5XX");
    // snprintf(getLaserData(1)->myLaserPortType, "tcp");
    // snprintf(getLaserData(1)->myLaserPort, "10.0.126.11:8102");
    snprintf(getLaserData(1)->myLaserType, sizeof(getLaserData(1)->myLaserType), "%s", "tim5XX");
    snprintf(getLaserData(1)->myLaserPortType, sizeof(getLaserData(1)->myLaserPortType), "%s", "tcp");
    snprintf(getLaserData(1)->myLaserPort, sizeof(getLaserData(1)->myLaserPort), "%s", "10.0.126.11:8102");
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2at");
  myRobotRadius = 500;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 300; 
  ...
  if (getLaserData(1) != NULL)
  {
    snprintf(getLaserData(1)->myLaserType, sizeof(getLaserData(1)->myLaserType), "lms2xx");
    snprintf(getLaserData(1)->myLaserPortType, sizeof(getLaserData(1)->myLaserPortType), "serial");
    snprintf(getLaserData(1)->myLaserPort, sizeof(getLaserData(1)->myLaserPort), "COM3");
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2at8");
  myRobotRadius = 500;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 300;
  myAbsoluteMaxVelocity = 1200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2it");
  myRobotRadius = 500;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 300;
  myAbsoluteMaxVelocity = 1200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2dx");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2de");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2df");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2d8");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2ce");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2pp");
  myRobotRadius = 300;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p2pb");
  myRobotRadius = 300;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "perfpb");
  myRobotRadius = 340;
  myRobotDiagonal = 120; 
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "pion1m");
  myRobotRadius = 220;
  myRobotDiagonal = 90;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "psos1m");
  myRobotRadius = 220;
  myRobotDiagonal = 90;
  myAbsoluteMaxRVelocity = 100;
  myAbsoluteMaxVelocity = 400;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "psos43m");
  myRobotRadius = 220;
  myRobotDiagonal = 90;
  myAbsoluteMaxRVelocity = 100;
  myAbsoluteMaxVelocity = 400;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "pionat");
  myRobotRadius = 330;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 100;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "pion1x");
  myRobotRadius = 220;
  myRobotDiagonal = 90;
  myAbsoluteMaxRVelocity = 100;
  myAbsoluteMaxVelocity = 400;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "psos1x");
  myRobotRadius = 220;
  myRobotDiagonal = 90;
  myAbsoluteMaxRVelocity = 100;
  myAbsoluteMaxVelocity = 400;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "mappr");
  myRobotRadius = 180;
  myRobotDiagonal = 120;
...
AREXPORT ArRobotPowerBot::ArRobotPowerBot(const char *dir)
{
  ...
  snprintf(mySubClass, sizeof(mySubClass), "%s", "powerbot");
  myRobotRadius = 550;
  myRobotDiagonal = 240; 
  ...
  if (getLaserData(1) != NULL)
  {
    snprintf(getLaserData(1)->myLaserType, sizeof(getLaserData(1)->myLaserType),  "lms2xx");
    snprintf(getLaserData(1)->myLaserPortType, sizeof(getLaserData(1)->myLaserPortType), "serial");
    snprintf(getLaserData(1)->myLaserPort, sizeof(getLaserData(1)->myLaserPort), "COM2");
    getLaserData(1)->myLaserX = 251;
    getLaserData(1)->myLaserY = 0;
    getLaserData(1)->myLaserFlipped = true;
  }

  snprintf(myGPSPort, sizeof(myGPSPort), "%s", "COM3"); // swap laser and hypothetical gps
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p3at");
  myRobotRadius = 500;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 300;
  myAbsoluteMaxVelocity = 1200;
  ...
  myGPSX = -160;
  myGPSY = 120;
  snprintf(myGPSType, sizeof(myGPSType), "%s","novatel");
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p3dx");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p3dx-sh");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p3at-sh");
  myRobotRadius = 500;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 300;
  myAbsoluteMaxVelocity = 1200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p3atiw-sh");
  myRobotRadius = 500;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 300;
  myAbsoluteMaxVelocity = 1200;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "patrolbot-sh");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
  ...
  {
    snprintf(getLaserData(2)->myLaserType, sizeof(getLaserData(2)->myLaserType),  "urg");
    snprintf(getLaserData(2)->myLaserPortType, sizeof(getLaserData(2)->myLaserPortType), "serial");
    snprintf(getLaserData(2)->myLaserPort, sizeof(getLaserData(2)->myLaserPort), "COM5");
    getLaserData(2)->myLaserX = 200;
    getLaserData(2)->myLaserY = 0;
    getLaserData(2)->myLaserFlipped = true;
    snprintf(getLaserData(2)->myLaserStartDegrees, sizeof(getLaserData(2)->myLaserStartDegrees), "%s", "-55");
    snprintf(getLaserData(2)->myLaserEndDegrees, sizeof(getLaserData(2)->myLaserEndDegrees), "55");
    snprintf(getLaserData(2)->myLaserIncrement, sizeof(getLaserData(2)->myLaserIncrement), "1.0");
  }
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "peoplebot-sh");
  myRobotRadius = 340;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
...
AREXPORT ArRobotPowerBotSH::ArRobotPowerBotSH(const char *dir)
{
  ...
  snprintf(mySubClass, sizeof(mySubClass), "%s", "powerbot-sh");
  myRobotRadius = 550;
  myRobotDiagonal = 240; 
  myAbsoluteMaxRVelocity = 360;
  myAbsoluteMaxVelocity = 2000;
...
AREXPORT ArRobotPowerBotSHuARCS::ArRobotPowerBotSHuARCS(const char *dir)
{
  ...
  snprintf(mySubClass, sizeof(mySubClass), "%s", "powerbot-sh-uarcs");
  myRobotRadius = 550;
  myRobotDiagonal = 240; 
  myAbsoluteMaxRVelocity = 360;
  myAbsoluteMaxVelocity = 2000;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "wheelchair-sh");
  myRobotRadius = 550;
  myRobotDiagonal = 300; 
  myAbsoluteMaxRVelocity = 360;
  myAbsoluteMaxVelocity = 2000;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "seekur");
  myRobotRadius = 833;
  myRobotDiagonal = 400; 
  ...
  myGPSX = -200;
  myGPSY = 0;
  snprintf(myGPSPort, sizeof(myGPSPort), "%s", "COM2"); 
  snprintf(myGPSType, sizeof(myGPSPort), "%s", "trimble");
  myGPSBaud = 38400;
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "mt400");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
  ...
  if (getLaserData(2) != NULL)
  {
    ...
    getLaserData(2)->myLaserY = 0;
    getLaserData(2)->myLaserFlipped = true;
    snprintf(getLaserData(2)->myLaserStartDegrees, sizeof(getLaserData(2)->myLaserStartDegrees), "-120");
    snprintf(getLaserData(2)->myLaserEndDegrees, sizeof(getLaserData(2)->myLaserEndDegrees), "120");
    snprintf(getLaserData(2)->myLaserIncrement, sizeof(getLaserData(2)->myLaserIncrement), "1.0");
  }
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "researchPB");
  myRobotRadius = 250;
  myRobotDiagonal = 120;
  myAbsoluteMaxRVelocity = 500;
  myAbsoluteMaxVelocity = 2200;
  ...
  if (getLaserData(2) != NULL)
  {
    ...
    getLaserData(2)->myLaserY = 0;
    getLaserData(2)->myLaserFlipped = true;
    snprintf(getLaserData(2)->myLaserStartDegrees, sizeof(getLaserData(2)->myLaserStartDegrees), "-55");
    snprintf(getLaserData(2)->myLaserEndDegrees, sizeof(getLaserData(2)->myLaserEndDegrees), "55");
    snprintf(getLaserData(2)->myLaserIncrement, sizeof(getLaserData(2)->myLaserIncrement), "1.0");
  }
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "seekurjr");
  myRobotRadius = 600;
  myRobotDiagonal = 600; 
  ...
  if (getLaserData(1) != NULL)
  {
    snprintf(getLaserData(1)->myLaserType, sizeof(getLaserData(1)->myLaserType),  "lms1XX");
    snprintf(getLaserData(1)->myLaserPortType, sizeof(getLaserData(1)->myLaserPortType), "tcp");
    snprintf(getLaserData(1)->myLaserPort, sizeof(getLaserData(1)->myLaserPort), "192.168.0.1");
    getLaserData(1)->myLaserX = 527;
    getLaserData(1)->myLaserY = 0;
    getLaserData(1)->myLaserFlipped = false;
    getLaserData(1)->myLaserPowerControlled = false;
    snprintf(getLaserData(1)->myLaserStartDegrees, sizeof(getLaserData(1)->myLaserStartDegrees), "-117");
    snprintf(getLaserData(1)->myLaserEndDegrees, sizeof(getLaserData(1)->myLaserEndDegrees), "117");
    getLaserData(1)->myLaserAutoConnect = true;
  }

  if (getLaserData(2) != NULL)
  {
    snprintf(getLaserData(2)->myLaserType, sizeof(getLaserData(2)->myLaserType),  "lms1XX");
    snprintf(getLaserData(2)->myLaserPortType, sizeof(getLaserData(2)->myLaserPortType), "tcp");
    snprintf(getLaserData(2)->myLaserPort, sizeof(getLaserData(2)->myLaserPort), "192.168.0.2");
    getLaserData(2)->myLaserX = -527;
    getLaserData(2)->myLaserY = 0;
    getLaserData(2)->myLaserFlipped = false;
    getLaserData(2)->myLaserPowerControlled = false;
    snprintf(getLaserData(2)->myLaserStartDegrees, sizeof(getLaserData(2)->myLaserStartDegrees), "-117");
    snprintf(getLaserData(2)->myLaserEndDegrees, sizeof(getLaserData(2)->myLaserEndDegrees), "117");
  }
  ...
  myGPSY = 0;
  snprintf(myGPSPort, sizeof(myGPSPort), "%s", "COM2"); 
  snprintf(myGPSType, sizeof(myGPSType), "%s", "trimble");
  myGPSBaud = 38400;
...
AREXPORT ArRobotP3DXSH_lms1xx::ArRobotP3DXSH_lms1xx(const char *dir) :
  ArRobotP3DXSH(dir)
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p3dx-sh-lms1xx");
  if(LaserData* ld = getLaserData(1))
  {
    snprintf(ld->myLaserType, sizeof(ld->myLaserType), "%s", "lms5XX");
    snprintf(ld->myLaserPortType, sizeof(ld->myLaserPortType), "%s", "tcp");
    snprintf(ld->myLaserPort, sizeof(ld->myLaserPort), "%s", "192.168.0.1");
    ld->myLaserX = 55;
  }
}
...
AREXPORT ArRobotP3ATSH_lms1xx::ArRobotP3ATSH_lms1xx(const char *dir) :
  ArRobotP3ATSH(dir)
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p3at-sh-lms1xx");
  if(LaserData* ld = getLaserData(1))
  {
    snprintf(ld->myLaserType, sizeof(ld->myLaserType), "%s", "lms5XX");
    snprintf(ld->myLaserPortType, sizeof(ld->myLaserPortType), "%s", "tcp");
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "peoplebot-sh-lms1xx");
  if(LaserData* ld = getLaserData(1))
  {
    // snprintf(ld->myLaserType, "lms1XX");
    // snprintf(ld->myLaserPortType, "tcp");
    // snprintf(ld->myLaserPort, "192.168.0.1");
    snprintf(ld->myLaserType, sizeof(ld->myLaserType), "%s", "lms1XX");
    snprintf(ld->myLaserPortType, sizeof(ld->myLaserPortType), "%s", "tcp");
    snprintf(ld->myLaserPort, sizeof(ld->myLaserPort), "%s", "192.168.0.1");
    ld->myLaserX = 55;
  }
...
AREXPORT ArRobotP3DXSH_lms500::ArRobotP3DXSH_lms500(const char *dir) :
  ArRobotP3DXSH(dir)
{
  // snprintf(mySubClass, "p3dx-sh-lms500");
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p3dx-sh-lms500");
  if(LaserData* ld = getLaserData(1))
  {
    // snprintf(ld->myLaserType, "lms5XX");
    // snprintf(ld->myLaserPortType, "tcp");
    // snprintf(ld->myLaserPort, "192.168.0.1");
    snprintf(ld->myLaserType, sizeof(ld->myLaserType), "%s", "lms5XX");
    snprintf(ld->myLaserPortType, sizeof(ld->myLaserPortType), "%s", "tcp");
...
AREXPORT ArRobotP3ATSH_lms500::ArRobotP3ATSH_lms500(const char *dir) :
  ArRobotP3ATSH(dir)
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "p3at-sh-lms500");
  if(LaserData* ld = getLaserData(1))
  {
    snprintf(ld->myLaserType, sizeof(ld->myLaserType), "%s", "lms5XX");
    snprintf(ld->myLaserPortType, sizeof(ld->myLaserPortType), "%s", "tcp");
...
AREXPORT ArRobotPeopleBotSH_lms500::ArRobotPeopleBotSH_lms500(const char *dir) :
  ArRobotPeopleBotSH(dir)
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "peoplebot-sh-lms500");
  if(LaserData* ld = getLaserData(1))
  {
    snprintf(ld->myLaserType, sizeof(ld->myLaserType), "%s", "lms5XX");
    snprintf(ld->myLaserPortType, sizeof(ld->myLaserPortType), "%s", "tcp");
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "powerbot-sh-lms500");
  if(LaserData* ld = getLaserData(1))
  {
    snprintf(ld->myLaserType, sizeof(ld->myLaserType), "%s", "lms5XX");
    snprintf(ld->myLaserPortType, sizeof(ld->myLaserPortType), "%s", "tcp");
...
{
  snprintf(mySubClass, sizeof(mySubClass), "%s", "researchPB-lms500");
  if(LaserData* ld = getLaserData(1))
  {
    snprintf(ld->myLaserType, sizeof(ld->myLaserType), "%s", "lms5XX");
    snprintf(ld->myLaserPortType, sizeof(ld->myLaserPortType), "%s", "tcp");
...
{
  snprintf(myClass, sizeof(myClass), "%s", "MTX");
  snprintf(mySubClass, sizeof(mySubClass), "%s", "pioneer-lx");
  myRobotRadius = 348;
  myRobotDiagonal = 120;
  ...
  {
    snprintf(laser->myLaserType, sizeof(laser->myLaserType), "%s", "s3series");
    snprintf(laser->myLaserPortType, sizeof(laser->myLaserPortType), "%s", "serial422");
#ifdef WIN32
	snprintf(laser->myLaserPort, ArUtil::COM7);
#else
  snprintf(laser->myLaserPort, sizeof(laser->myLaserPort), "%s", "/dev/ttyUSB4");

#endif
    snprintf(laser->myLaserStartingBaudChoice, sizeof(laser->myLaserStartingBaudChoice), "%s", "230400");
    laser->myLaserX = 267;
    laser->myLaserY = 0;
    laser->myLaserZ = 190;
  ...
  {
    snprintf(lcd->myLCDMTXBoardType, sizeof(lcd->myLCDMTXBoardType), "%s", "mtx");
    snprintf(lcd->myLCDMTXBoardPortType, sizeof(lcd->myLCDMTXBoardPortType), "%s", "serial422");
#ifdef WIN32
	snprintf(lcd->myLCDMTXBoardPort, ArUtil::COM11);
#else
    snprintf(lcd->myLCDMTXBoardPort, sizeof(lcd->myLCDMTXBoardPort), "%s", "/dev/ttyUSB8");
#endif
  ...
  {
    snprintf(sonar->mySonarMTXBoardType, sizeof(sonar->mySonarMTXBoardType), "%s",  "mtx");
    snprintf(sonar->mySonarMTXBoardPortType, sizeof(sonar->mySonarMTXBoardPortType), "%s",  "serial422");
#ifdef WIN32
	  snprintf(sonar->mySonarMTXBoardPort, ArUtil::COM5);
#else
    snprintf(sonar->mySonarMTXBoardPort, sizeof(sonar->mySonarMTXBoardPort), "%s", "/dev/ttyUSB2");
#endif
    ...
    snprintf(sonar->mySonarMTXBoardPowerOutput, sizeof(sonar->mySonarMTXBoardPowerOutput), "%s", "Sonar_1_Power");
  }
 
  /*
  if(SonarMTXBoardData *sonar = getSonarMTXBoardData(2))
  {
    snprintf(sonar->mySonarMTXBoardType, "mtx");
    snprintf(sonar->mySonarMTXBoardPortType, "serial422");
#ifdef WIN32
    snprintf(sonar->mySonarMTXBoardPort, ArUtil::COM6);
#else
    snprintf(sonar->mySonarMTXBoardPort, "/dev/ttyUSB3");
#endif
    sonar->mySonarMTXBoardBaud = 115200;
  ...
  */
  ...
  {
    snprintf(bat->myBatteryMTXBoardType, sizeof(bat->myBatteryMTXBoardType), "%s", "mtx");
    snprintf(bat->myBatteryMTXBoardPortType, sizeof(bat->myBatteryMTXBoardPortType), "%s", "serial");
#ifdef WIN32
	snprintf(bat->myBatteryMTXBoardPort, ArUtil::COM4);
#else
    snprintf(bat->myBatteryMTXBoardPort, sizeof(bat->myBatteryMTXBoardPort), "%s", "/dev/ttyUSB1");
#endif

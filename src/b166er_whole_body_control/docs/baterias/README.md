...
| 13 | `teto_postura/RELATORIO13_teto_por_postura.md` | teto_postura | teto de velocidade pela margem de tombamento da postura medida: frenagem seca 0,05–0,07 → 0,02 rad; escala conjunta base+braço; queda pós-execução é do reset |
